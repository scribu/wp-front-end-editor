...
var nicEditorSelect = bkClass.extend({
	...
	construct : function(e,buttonName,options,nicEditor) {
		...
		this.txt = new bkElement('div').setStyle({overflow : 'hidden', 'float' : 'left', width : '66px', height : '18px', lineHeight: '18px', fontFamily : 'sans-serif', textAlign : 'center', fontSize : '11px'}).addClass('selectTxt').appendTo(this.items);
...
var feeImageOptions = {
	buttons : {
		'image' : {name : __('Add Image'), type : 'feeImageButton'}
	}
};
/* END CONFIG */

var feeImageButton = nicEditorAdvancedButton.extend({
	mouseClick : function() {
		new FrontEndEditor.fieldTypes['image_rich'](this.ne);
	}
});

nicEditors.registerPlugin(nicPlugin,feeImageOptions);
